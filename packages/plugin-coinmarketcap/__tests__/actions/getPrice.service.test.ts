...
describe('PriceService', () => {
  ...
  it('should handle missing symbol data', async () => {
    ...
    await expect(priceService.getPrice('INVALID', 'USD')).rejects.toThrow(
  ...
  it('should handle missing quote data', async () => {
    ...
    await expect(priceService.getPrice('BTC', 'INVALID')).rejects.toThrow(
      'No quote data found for currency: INVALID'
    );
  });
  ...
  it('should handle API errors', async () => {
    ...
    await expect(priceService.getPrice('BTC', 'USD')).rejects.toThrow(`${errorMessage}`);
  });
  ...
  it('should handle non-axios errors', async () => {
    ...
    await expect(priceService.getPrice('BTC', 'USD')).rejects.toThrow('Network error');
  });
});
